(function (React, ReactDOM) {
  ...
  function cleanID(val) {
      if (typeof val === 'string') {
          val = VALID_OPTION_INPUTS.id(val)
              ? +val.slice(0, 10)
              : 0;
      } else if (typeof val !== 'number') {
          return 0;
  ...
  class BikesDB {
       ...
       */
      update() {
          const opts = this._pageOptions;
          const db = this._db;
          if (opts.has('id')) {
              this._bikes = getBike(opts.id(), db);
          } else if (opts.has('from') || opts.has('to')) {
              this._available = getAvailableBikes(db, opts);
              this._matching = getMatchingBikes(db, opts);
              this._bikes = getSelectedBikes(this._available, this._matching);
          } else {
              this._available = db.data;
              this._matching = getMatchingBikes(db, opts);
   ...
   * @return {!Array<!Object>}
   */
  function getBike(id, db) {
      return id > db.data.length
          ? []
          : [ db.data[id - 1] ];
  }
  ...
  function Filters({
    ...
    function handleIDChange(event) {
      ...
      const id = trimWhitespace(input.value);

      if (id && VALID_OPTION_INPUTS.id(id)) {
        opts.id(id);
      } else {
        opts.delete('id');
        input.value = '';
  ...
  function Bike({
    ...
    return /*#__PURE__*/React__default["default"].createElement("a", {
      href: href,
      className: "bikerow",
      title: 'Edit Bike #' + bike.id
    }, /*#__PURE__*/React__default["default"].createElement("div", {
      className: "bikecell"
    }, /*#__PURE__*/React__default["default"].createElement("p", null, "#", bike.id)), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "bikecell"
  ...
  function Bikes() {
    ...
    if (!authenticated || !loaded) {
      return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(ManagerNavBar, null), /*#__PURE__*/React__default["default"].createElement("h1", {
        className: "intro"
      }, "Manage Bikes"), /*#__PURE__*/React__default["default"].createElement(Loading, null));
    }
    ...
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(ManagerNavBar, null), /*#__PURE__*/React__default["default"].createElement(LogButtons, {
      ...
      className: "intro"
    }, "Manage Bikes"), /*#__PURE__*/React__default["default"].createElement(Filters, {
      opts: opts,
      db: db,
      bikes: bikes,
